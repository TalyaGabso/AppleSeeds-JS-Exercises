...
*/
const bus = (arr) => {
  return arr.reduce((people, station) => people + station[0] - station[1], 0);
}

//Examples 
console.log(bus([[2,0], [2,2], [3,0], [0,5]]));
console.log(bus([[1,0], [2,0], [3,2], [0,2]]));
console.log(bus([[5,0], [6,3], [2,1], [0,4]]));